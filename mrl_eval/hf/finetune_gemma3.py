...
# CUDA_VISIBLE_DEVICES=3,4 torchrun --nproc_per_node=2 --master_port=0 mrl_eval.hf.finetune --dataset hebnli --model "google/gemma-3-12b-it" 2>&1 | tee mrl_log_gemma3_12b_fast.txt
